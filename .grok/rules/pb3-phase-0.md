...
- **Stack core locked:** TS + React + R3F + Vite — `docs/decisions/ADR-002-stack-core-ts-react-r3f-vite.md`. Stage 3 (pkg manager, schema/state/test, fixture serve) still open. Lock is **not** implementation start.
