...
- **E2E locked (project practice):** Playwright headless Chromium — `e2e/exit-scenario.spec.ts`, `pnpm test:e2e` (ADR-003 amendment). Prefer `pnpm test:all` before hand-off or tag.
