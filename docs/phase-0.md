...
4. Stack ADR + scaffold (TypeScript / Vite / UI / 3D) that consumes the fixtures — **next**
...
| [docs/roadmap/PHASES.md](./roadmap/PHASES.md) | Phase list |
| [docs/verification/VERTICAL_SLICE_EXIT_CRITERIA.md](./verification/VERTICAL_SLICE_EXIT_CRITERIA.md) | Pointer to this exit checklist |
