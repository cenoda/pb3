...
| Phase 2 — Basic estimate service | [`phase-2/`](./phase-2/) | M0 planning package drafted (scope, data contract, implementation plan); not owner-accepted; implementation not started |
