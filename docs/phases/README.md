...
| Phase 4.1 — Combination performance estimator (sub-path) | [`phase-4.1/`](./phase-4.1/) | O1–O9 locked; M0 plan package drafted (`est1`); impl not started; temporary draft fn; not Phase 5 |
