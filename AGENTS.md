...
| Current planning gate | **Phase 6 complete and owner-closed (2026-08-12)** — `docs/phases/phase-6/`. **Phase 7 complete and owner-approved (2026-08-13)** — catalog grid picker + image registry; O2 floor missed for 6/7 categories (CPU only) — `docs/phases/phase-7/`. **Phase 7.1 first slice software-closed (2026-08-13)** — `ing7` dry-run pipeline; O1–O10 locked; collection increment may add candidate data + live Commons/AMD parsers; still no apply/ship. Do not start Step 9–10 or Phase 8 until asked — `docs/phases/phase-7.1/`. Phase 5 remains complete (owner-approved 2026-08-09). **Phase 4 M0 fully closed (2026-08-13)**; **Phase 4 + 4.1 remain frozen** — see `docs/phases/phase-4/FREEZE.md`; do not silently break `prov4`/`est1` |
