...
| Current planning gate | **Phase 6 in progress (2026-08-10)** — `docs/phases/phase-6/`; M0 accepted, O1–O8 locked, Step 1 (`cat6` contract) done, Steps 2–12 open. Follow the phase implementation plan and its untouchable-area table. Phase 5 complete (owner-approved 2026-08-09). **Phase 4 + 4.1 remain frozen** — see `docs/phases/phase-4/FREEZE.md`; Step 9 / full sim not claimed; do not silently break `prov4`/`est1` |
